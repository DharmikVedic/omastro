          ...
          <div className=" flex gap-5">
            ...
            <ul className="md:flex gap-10 text-lg text-zinc-800 items-center  hidden">
              ...
              <div
                ...
                className="border-2 cursor-pointer items-center flex gap-4 shadow-md shadow-red-400/20 border-red-500   py-2 px-2 rounded-md text-zinc-800 font-bold"
              >
                <svg
              ...
              {user !== null ? (
                <div className="relative group py-2 cursor-default">
                  <div className="  shadow-lg shadow-red-300/30 bg-red-400 text-sm text-white font-semibold py-2 px-4 rounded-md">
