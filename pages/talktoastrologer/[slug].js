...
export default function Astrologer({ name }) {
  ...
  const handleCall = () => {
    if (user === null) {
      ...
      storeCurrentAstrologer(data[0].id, user.email, 0);
    }
  };
  ...
  useEffect(async () => {
    const mySubscription = supabase
      ...
      .on("*", (payload) => {
        ...
        let array;
        if (payload.new) {
          array = data[0].id === payload.new.id ? payload.new : item;
          setstate([array]);
        }
      })
      .subscribe();
  ...
  return (
    <>
      ...
      />
      <div className="min-h-screen py-40 bg-zinc-50">
        {data !== null && !loader ? (
          <div className="  px-5">
              ...
              <div className=" border bg-white shadow-lg    md:px-16 px-10 py-8 md:py-16 border-red-300 shadow-red-100 flex gap-10 rounded-[20px] md:gap-20 flex-row items-start md:items-center">
                ...
                <div className="flex flex-col gap-3 w-full">
                      ...
                      .map((item, i) => (
                        <span
                          ...
                          className={`capitalize px-3 py-1 text-[16px] rounded-md text-sm font-semibold ${
                            color[item.toLowerCase()] !== undefined
                  ...
                  <button
                    ...
                    className={`${
                      data[0].isActive && !data[0].currentQueue
                  ...
                  >
                    <span className="flex items-center gap-2">
                      ...
                      {!data[0].currentQueue ? "Call Now" : "Busy"}
                    </span>
