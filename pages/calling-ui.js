...
export default function CallingUi() {
  ...
  return (
    <div className="bg-violet-50 h-screen fixed w-full z-50 py-20 ">
...
316 0z"
        ...
        <div className="flex gap-10 ">
          <button className="rounded-md bg-red-500 w-full text-white font-bold p-3">
            Cancel
          </button>
          <button className="rounded-md bg-green-400 w-full text-white font-bold  p-3">
            Answer
          </button>
        </div>
      </div>
