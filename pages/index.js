        ...
        <div className="max-w-7xl flex md:flex-row flex-col gap-28 md:gap-10 sm:gap-20 mx-auto items-center ">
          ...
          <div className="flex  justify-center gap-5 w-full md:w-7/12	">
            <div className="grid grid-cols-2 grid-rows-2 max-w-lg w-full gap-10 circle">
              <div className="flex font-bold bg-white shadow-xl rounded-[30px] text-zinc-700  flex-col py-10 px-7 w-full justify-center text-center gap-3 text-2xl md:text-3xl">
                1000+
              ...
              <div className="row-span-2  flex justify-center">
                <div className="flex font-bold  w-full my-auto  bg-white  shadow-xl rounded-[30px] text-zinc-700  flex-col md:py-10  py-8 px-7 justify-center text-center gap-3 text-2xl leading-7 md:text-3xl">
                  5000+ Min
                  <span className="text-lg md:text-xl leading-6 font-normal">
                    Total Call Minutes
                  </span>
                </div>
              </div>

              <div className="flex font-bold bg-white  shadow-xl rounded-[30px] text-zinc-700  flex-col py-10 px-7 justify-center text-center gap-3 text-2xl md:text-3xl">
                100+
                <span className="text-lg md:text-xl leading-6 font-normal">
                  Total Customers
                </span>
        ...
        <div className="w-full">
          <div className=" flex overflow-x-auto w-full py-10">
            {review.map((item, i) => (
              <div
                key={i}
                className="flex relative w-full  min-w-[350px] cursor-default mr-10 flex-col hover:shadow-xl hover:shadow-rose-200/40 gap-6 py-12 px-7 border border-rose-200 bg-white rounded-xl"
              >
                ...
                <p className="text-zinc-600 text-base leading-7 pb-5">
                  {item.desc}
                </p>
